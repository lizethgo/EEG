...
x_train = np.concatenate((f_energy_a[:,0:27000],
                          #f_coastl_a[:,0:27000],
                          #f_alpha_a[:,0:27000],
                          f_beta_a[:,0:27000],
                          f_delta_a[:,0:27000],
                          ...
                          #f_gamma_4_a[:,0:27000],
                          f_theta_a[:,0:27000],
                          #f_n_energy_a[:,0:27000],
                          f_var_a[:,0:27000]), axis=0)

x_test = np.concatenate((f_energy_a[:,27000:],
                          #f_coastl_a[:,27000:],
                          # f_alpha_a[:,27000:],
                          f_beta_a[:,27000:],
                          f_delta_a[:,27000:],
...
x_train_seizure_1 = x_train[:,6769:6828+1]
x_train_seizure_2 = x_train[:,15859:15928+1]
x_train_seizure_3 = x_train[:,26529:26588+1]
...
x_train = np.concatenate((x_train,
                          np.repeat(x_train_seizure_1,10,1),
                          np.repeat(x_train_seizure_2,10,1),
                          np.repeat(x_train_seizure_3,10,1)),
                          axis=1)
...
y_test = labels_a[0,27000:]
y_train = labels_a[0,0:27000]  
y_train = np.concatenate((y_train, np.ones(10*60),np.ones(10*70),np.ones(10*60)))

print('y_train', np.shape(y_train))
print('x_train', np.shape(x_train))
print('y_test', np.shape(y_test))
print('x_text', np.shape(x_test))
...
n_connect_1 = 4 #nr of active active connections per output node (layer 1)
...
file=h5py.File('p_acc_0.9993333220481873.h5py','r')
weight = []
...
print(index_1)
seizure_1 = np.where(index_1[0] <7000 )
