...
x_train_seizure = x_train[:,9499:10098+1] 
print("x_train_seizure", np.shape(x_train_seizure))
print("x_train", np.shape(x_train))
x_train = np.concatenate((x_train,  
                          np.repeat(x_train_seizure,10,1)), axis=1)    
...
y_train = labels_a[0,5000:21600]  ## 9499 - 10098  --> 14499 - 15098
y_train = np.concatenate((y_train, np.ones(10*600)))
...
file=h5py.File('p_acc_0.973800003528595.h5py','r')
weight = []
